...
class Remedy_data extends \Controllers\Base
{
    ...
    protected $allowedSearchFields = ['symptoms'];

    protected $modelsMap = [
      'default' => 'Models\Remedy_data',
    ];
    ...
    public function getByRemedy()
    {
      $model = $this->getModel();
      $this->respond($model::getByRemedy($this->params['id']));
    }
}
